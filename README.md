...
```bash
Read and follow program.md to run an autoresearch session. Use the BO tool when you judge it helpful, and create a new autoresearch/<date> branch for this run.
```
